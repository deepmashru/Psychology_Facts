...
public class AndroidSettingsAdapter extends ArrayAdapter<FactData> {
    ...
    public AndroidSettingsAdapter(AppCompatActivity paramAppCompatActivity, ArrayList<FactData> paramArrayList) {
        super(paramAppCompatActivity, 0, paramArrayList);
    }
    ...
    public View getView(int paramInt, View paramView, @NonNull ViewGroup paramViewGroup) {
        ...
        FactData factData = getItem(paramInt);
