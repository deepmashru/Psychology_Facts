...
public class DetailAdapterForAllFacts extends RecyclerView.Adapter<DetailAdapterForAllFacts.FactViewHolder> {
    ...
    public void onBindViewHolder(FactViewHolder viewHolder, final int position) {
         ...
         */
        final FactData factData = this.mAndroidNews.get(position);
        ...
        viewHolder.shareImage.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                String stringBuilder = DetailAdapterForAllFacts.this.mAndroidNews.get(position).getTitle() +
        ...
        viewHolder.copyImage.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ((ClipboardManager) DetailAdapterForAllFacts.this.mContext.getSystemService(Context.CLIPBOARD_SERVICE)).setPrimaryClip(ClipData.newPlainText("CopyText", DetailAdapterForAllFacts.this.mAndroidNews.get(position).getTitle()));
    ...
    class FactViewHolder extends RecyclerView.ViewHolder {
        ...
        FactViewHolder(View param1View) {
            ...
            this.bottomTextView = param1View.findViewById(R.id.bottom_text_details);
            this.shareImage = param1View.findViewById(R.id.sharetext);
            this.copyImage = param1View.findViewById(R.id.copybord);
            this.saveImage = param1View.findViewById(R.id.bookMark);
        }
    }
